...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Instalar Plugins Base do Tema', 'tgmpa' ),
				...
				'notice_cannot_install'           => _n_noop(
					'Desculpe, mas você não tem a permissão correta para instalar o %1$s plugin.',
					'Desculpe, mas você não tem as permissões corretas para instalar o %1$s plugins.',
					'tgmpa'
				),
				'notice_ask_to_update'            => _n_noop(
					'O seguinte plugin precisa ser atualizado para sua versão mais recente para assegurar o máximo de compatibilidade com este tema: %1$s.',
					'Os seguintes plugins precisam ser atualizados para sua última versão para assegurar o máximo de compatibilidade com este tema: %1$s.',
					'tgmpa'
				),
				'notice_ask_to_update_maybe'      => _n_noop(
					'Há uma atualização disponível para: %1$s.',
					'Há uma atualização disponível para os seguintes plugins: %1$s.',
					'tgmpa'
				),
				'notice_cannot_update'            => _n_noop(
					'Desculpe, mas você não tem a permissão correta para atualizar o %1$s plugin.',
					'Desculpe, mas você não tem a permissão correta para atualizar os %1$s plugins.',
					'tgmpa'
				),
				'notice_can_activate_required'    => _n_noop(
					'O seguinte plugin é necessário, mas se encontra inativo: %1$s.',
					'Os seguintes plugins são necessários, mas se encontram inativos: %1$s.',
					'tgmpa'
				),
				'notice_can_activate_recommended' => _n_noop(
					'O seguinte plugin é recomendado, mas se encontra inativo: %1$s.',
					'Os seguintes plugins são recomendados, mas se encontram inativos: %1$s.',
					'tgmpa'
				),
				'notice_cannot_activate'          => _n_noop(
					'Desculpe, mas você não tem a permissão correta para ativar o %1$s plugin.',
					'Desculpe, mas você não tem a permissão correta para ativar os %1$s plugins.',
					'tgmpa'
				),
				'install_link'                    => _n_noop(
					'Comece a instalação de plugin',
					'Começe a instalação dos plugins',
					'tgmpa'
				),
				'update_link'                     => _n_noop(
					'Comece a atualização de plugin',
					'Começe a atualização dos plugins',
					'tgmpa'
				),
				'activate_link'                   => _n_noop(
					'Comece a ativação de plugin',
					'Começe a ativação dos plugins',
					'tgmpa'
				),
				'return'                          => __( 'Voltar para área de instalaçao dos plugins necessários', 'tgmpa' ),
				'dashboard'                       => __( 'Retornar para o painel', 'tgmpa' ),
				'plugin_activated'                => __( 'Plugin ativado com sucesso!', 'tgmpa' ),
				'activated_successfully'          => __( 'O seguinte plugin foi ativado com sucesso:', 'tgmpa' ),
				'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'tgmpa' ),
				'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'tgmpa' ),
				'complete'                        => __( 'Todos os plugins foram instalados e ativados com sucesso! %1$s', 'tgmpa' ),
				'dismiss'                         => __( 'Ignorar esta estapa importante.', 'tgmpa' ),
				'contact_admin'                   => __( 'Por favor conte o administrador do site para te ajudar.', 'tgmpa' ),
			);

 ...
 * Description: Opções do Tema UI Builder for WordPress. A simple way to create & save Opções do Tema and Meta Boxes for free or premium themes.
 * Version:     2.5.5
 * Author:      Derek Herman
...
if ( ! class_exists( 'OT_Loader' ) ) {
  ...
  class OT_Loader {
    ...
    private function constants() {
      ...
      /**
       * For developers: Show Opções do Tema UI Builder
       *
       * Run a filter and set to false if you want to hide the
       * Opções do Tema UI page in the admin area of WordPress.
       *
       * @since     2.1
       */
       ...
       * "New Layout" section at the top of the Opções do Tema page.
       *
       * @since     2.0.10
       */

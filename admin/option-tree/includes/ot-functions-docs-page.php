  ...
  function ot_type_creating_options() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Enter a detailed description for the users to read on the Opções do Tema page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'option-tree' ) . '</p>';
  ...
  function ot_type_option_types() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . sprintf( __( 'The CSS option type is a textarea that when used properly can add dynamic CSS to your theme from within OptionTree. Unfortunately, due server limitations you will need to create a file named %s at the root level of your theme and change permissions using %s so the server can write to the file. I have had the most success setting this single file to %s but feel free to play around with permissions until everything is working. A good starting point is %s. When the server can save to the file, CSS will automatically be updated when you save your Opções do Tema.', 'option-tree' ), '<code>dynamic.css</code>', '<code>chmod</code>', '<code>0777</code>', '<code>0666</code>' ) . '</p>';
        
        echo '<p class="aside">' . sprintf( __( 'This example assumes you have an option with the ID of %1$s. Which means this option will automatically insert the value of %1$s into the %2$s when the Opções do Tema are saved.', 'option-tree' ), '<code>demo_background</code>', '<code>dynamic.css</code>' ) . '</p>';
  ...
  function ot_type_layouts_overview() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Layouts make your theme awesome! With Opções do Tema data that you can save/import/export you can package themes with different color variations, or make it easy to do A/B testing on text and so much more. Basically, you save a snapshot of your data as a layout.', 'option-tree' ) . '</p>';
        ...
        echo '<ul class="docs-ul">';
          echo '<li>'. __( 'Go to the <code>Appearance->Opções do Tema</code> page.', 'option-tree' ) . '</li>';
          echo '<li>' . __( 'Modify and save your Opções do Tema and the layout will be updated automatically.', 'option-tree' ) . '</li>';
          echo '<li>' . __( 'Saving Opções do Tema data will update the currently active layout, so before you start saving make sure you want to modify the current layout.', 'option-tree' ) . '</li>';
          echo '<li>' . __( 'If you want to edit a new layout, first create it then save your Opções do Tema.', 'option-tree' ) . '</li>';
        echo '</ul>';
        ...
        echo '<h5>' . __( 'Edit Layout Data', 'option-tree' ) . ':</h5>';
        echo '<ul class="docs-ul">';
          echo '<li>'. __( 'Go to the <code>Appearance->Opções do Tema</code> tab.', 'option-tree' ) . '</li>';
          echo '<li>' . __( 'Modify and save your Opções do Tema and the layout will be updated automatically.', 'option-tree' ) . '</li>';
          echo '<li>' . __( 'Saving Opções do Tema data will update the currently active layout, so before you start saving make sure you want to modify the current layout.', 'option-tree' ) . '</li>';
        echo '</ul>';
...
require( trailingslashit( get_template_directory() ) . \'option-tree/ot-loader.php\' );
        ...
        echo '<h5>' . __( 'Step 2: Create Opções do Tema without using the UI Builder.', 'option-tree' ) . '</h5>';
        echo '<ul class="docs-ul">';

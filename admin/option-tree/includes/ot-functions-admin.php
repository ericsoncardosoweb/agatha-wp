          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'Opções do Tema', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'Opções do Tema', 'option-tree' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'Opções do Tema updated.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'Opções do Tema reset.', 'option-tree' ) ),
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . __( 'The Opções do Tema UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'option-tree' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'Opções do Tema', 'option-tree' ),
        'menu_title'      => __( 'Opções do Tema', 'option-tree' ),
      ...
      array(
        ...
        'page_title'      => __( 'Configurações', 'option-tree' ),
        'menu_title'      => __( 'Configurações', 'option-tree' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Atualizar Opções do Tema.', 'option-tree' ),
        'reset_message'   => __( 'Resetar Opções do Tema.', 'option-tree' ),
        'button_text'     => __( 'Salvar Configurações', 'option-tree' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => __( 'TOpções do Tema UI', 'option-tree' )
          ),
          array(
            'id'          => 'import',
            'title'       => __( 'Importar', 'option-tree' )
          ),
          array(
            'id'          => 'export',
            'title'       => __( 'Exportar', 'option-tree' )
          ),
          array(
            'id'          => 'layouts',
        ...
        'settings'        => array(
          array(
            ...
            'label'       => __( 'Opções do Tema UI Builder', 'option-tree' ),
          ...
          array(
            'id'          => 'import_data_text',
            'label'       => __( 'Opções do Tema', 'option-tree' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
      ...
      array(
        ...
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => __( 'Opções do Tema updated.', 'option-tree' ),
        'reset_message'   => __( 'Opções do Tema reset.', 'option-tree' ),
...
/**
 * Runs directly after the Opções do Tema are save.
 *
 * @return    void
 *
 * @access    public
...
if ( ! function_exists( 'ot_after_theme_options_save' ) ) {
  ...
  function ot_after_theme_options_save() {
    ...
    /* only execute after the Opções do Tema are saved */
    if ( apply_filters( 'ot_theme_options_menu_slug', 'ot-theme-options' ) == $page && $updated ) {
      
      /* grab a copy of the Opções do Tema */
      $options = get_option( ot_options_id() );
      
      /* execute the action hook and pass the Opções do Tema to it */
...
if ( ! function_exists( 'ot_import' ) ) {
  ...
  function ot_import() {
    ...
    /* check and verify import Opções do Tema data nonce */
...
' . implode( ",\n", $setting_std_array ) . '
    ...
    $content.= "<?php
/**
 * Initialize the custom Opções do Tema.
 */
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . __( '<strong>Section Title</strong>: Displayed as a menu item on the Opções do Tema page.', 'option-tree' ) . '</div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Label</strong>: Displayed as the label of a form element on the Opções do Tema page.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . __( '<strong>Description</strong>: Enter a detailed description for the users to read on the Opções do Tema page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . __( '<strong>Title</strong>: Displayed as a contextual help menu item on the Opções do Tema page.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
...
/**
 * Helper function to display Opções do Tema layouts form.
 *
 * @return    string
 *
 * @access    public
...
function ot_wpml_register_string( $id, $value ) {
  ...
  if ( function_exists( 'icl_register_string' ) ) {
    ...
    icl_register_string( 'Opções do Tema', $id, $value );
...
if ( ! function_exists( 'ot_maybe_migrate_options' ) ) {
  ...
  function ot_maybe_migrate_options() {
    ...
    // Attempt to migrate Opções do Tema
...
/**
 * Build an array of potential Opções do Tema that could share terms
 *
 * @return    array
 *
 * @access    private
